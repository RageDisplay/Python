...
class Main(Frame):
    ...
    def startUI(self):
        ...
        self.lbl = Label(root, text="Начинается передача", bg="#B2DFDB", font=("Calibri", 30, "bold"))
        ...
        self.lbl3 = Label(root, text="Миндальная связь установлена", bg="#66FFCC", font=("Calibri", 30, "bold"))
        self.lbl3.place(x=220, y=20)
        
    def btn_click(self, choise):
        enemy_choise = rdm.randint(1, 3)

        if (choise == enemy_choise):
            self.drow += 1
